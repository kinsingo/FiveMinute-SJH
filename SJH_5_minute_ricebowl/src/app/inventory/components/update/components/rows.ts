...
const rows: InventoryItem[] = [
  ...
  new InventoryItem("기타 식재료", "우동액다시", "통"),
  new InventoryItem("기타 식재료", "스팸", "통"),
  new InventoryItem("기타 식재료", "참치", "통"),
  new InventoryItem("기타 식재료", "식용유", "통"),
  ...
  new InventoryItem("에이드 소스", "망고에이드", "통"),
  new InventoryItem("에이드 소스", "레몬에이드", "통"),
  new InventoryItem("에이드 소스", "청포도에이드", "통"),
  new InventoryItem("에이드 소스", "자몽에이드", "통"),
  new InventoryItem("포장 용기", "밥용기 (크라프트)", "줄"),
  new InventoryItem("포장 용기", "장국용기", "줄"),
  new InventoryItem("포장 용기", "계란장용기", "줄"),
  new InventoryItem("포장 용기", "카레용기", "줄"),
  new InventoryItem("포장 용기", "찌개용기", "줄"),
  new InventoryItem("포장 용기", "종이봉투", "묶음"),
  new InventoryItem("포장 용기", "숟가락", "박스"),
  new InventoryItem("포장 용기", "젓가락", "박스"),
  new InventoryItem("포장 용기", "랩", "개"),
  new InventoryItem("포장 용기", "에이드 용기", "묶음"),
  new InventoryItem("포장 용기", "빨대", "묶음"),
  new InventoryItem("포장 용기", "에이드 비닐", "묶음"),
  new InventoryItem("포장 용기", "비닐봉투 (소)", "묶음"),
  new InventoryItem("포장 용기", "비닐봉투 (중)", "묶음"),
  new InventoryItem("포장 용기", "비닐봉투 (대)", "묶음"),
  new InventoryItem("포장 용기", "비닐봉투 (특대)", "묶음"),
  new InventoryItem("기타", "키친타올", "개"),
  new InventoryItem("기타", "핸드워시", "개"),
  new InventoryItem("기타", "주방세재", "통"),
  new InventoryItem("기타", "영수증용지", "박스"),
  new InventoryItem("직원 간식", "커피", "개"),
  new InventoryItem("직원 간식", "깔라만씨", "개"),
];
